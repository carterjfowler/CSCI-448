...
//        fun newInstance(latitude: Double, longitude: Double) : LocatrFragment {
//            val args = Bundle().apply {
//                putSerializable(ARG_LATITUDE_ID, latitude)
//                putSerializable(ARG_LONGITUDE_ID, longitude)
//            }
//            return LocatrFragment().apply { arguments = args }
//        }
    }
...
//        val latitude = arguments?.getDouble(ARG_LATITUDE_ID, UNKNOWN_POSITION)
//            ?: UNKNOWN_POSITION
//        val longitude = arguments?.getDouble(ARG_LONGITUDE_ID, UNKNOWN_POSITION)
//            ?: UNKNOWN_POSITION
